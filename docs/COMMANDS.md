...
basic use:
  ...
  grimchain --pdf-embed PATH
  grimchain NUMBER --pdf-embed PATH
      Append the PDF GrimChain self-return to PATH. With NUMBER, the return uses
      that exact middle depth. Without NUMBER, it uses the zero-depth middle.
  ...
  grimchain --pdf-rm-embed PATH
      ...
      PDF body beneath that return. A missing or non-closing return is refused.
```
